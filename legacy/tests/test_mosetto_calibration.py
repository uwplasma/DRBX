...
def test_mosetto_reference_thresholds_gamma1_match_reported_values() -> None:
    # Reported in the Mosetto 2012 transition discussion (for g=1, ŝ=0) as ~75.2 and ~18.8.
...
def test_calibrated_classifier_produces_all_four_regimes() -> None:
    ...
    # Pick points relative to analytic thresholds:
    #   d = eta/me_hat and R/Ln proxy = 40 * omega_n.
    # Inertial + DW => InDW
