...
from jaxdrb.models.hot_ion_drb import Equilibrium, State, rhs_nonlinear
...
def main() -> None:
    ...
    print("Hot-ion ES line RHS norms:")
    print({"n": norm(dy.n), "omega": norm(dy.omega), "Ti": norm(dy.Ti)})
