"""Legacy characteristic wall-state reconstruction helpers.

These projection-based helpers remain for compatibility while physical wall
closures migrate to a complete boundary-state bundle consumed by the live
characteristic face flux.  New wall laws must not assume a fixed number of
incoming modes or solve a fixed-size incoming-amplitude system here.
"""
