...
def _advance_recycling_1d_fixed_bdf2_history(
    ...
    *,
    ...
    diagnostics: dict[str, float | int | bool | str | None] = {
        ...
        "fixed_bdf2_total_linear_operator_dispatch_seconds": 0.0,
    ...
    def record_step(info: Recycling1DImplicitStepInfo, *, method: str) -> None:
        ...
        diagnostics["fixed_bdf2_total_linear_operator_dispatch_seconds"] = float(
            diagnostics["fixed_bdf2_total_linear_operator_dispatch_seconds"]
        ) + float(info.diagnostics.get("linear_operator_dispatch_seconds", 0.0))
...
def _resolve_recycling_jax_linear_preconditioner_name(
    ...
    aliases = {
        ...
        "field_block_sample": "field_block_sample",
        "field_sample_block": "field_block_sample",
        "sampled_field_block": "field_block_sample",
        "field_split": "field_block_sample",
...
def _as_recycling_step_info(
    ...
    *,
    ...
    diagnostics: dict[str, float | int | bool | str | None] = {
        ...
        "linear_update_finite": getattr(info, "linear_update_finite", None),
        "linear_update_inf_norm": getattr(info, "linear_update_inf_norm", None),
