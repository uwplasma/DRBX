...
def build_hermes_capability_audit() -> dict[str, object]:
    families = [
        ...
        },
        {
            ...
            "jax_status": "partially_closed",
            "jax_capability": "native_rhs_exact_bounded_full_short_window_metric_window",
            "evidence": [
            ...
            "next_gate": "promote the broader full-array short-window surface if a standalone full-field neutral claim is desired",
        },
        {
        ...
        },
        {
            ...
            "jax_status": "partially_closed",
            "jax_capability": "native_exact_first_output_plus_bounded_two_output_and_neon_windows",
            "evidence": [
