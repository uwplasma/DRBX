...
def create_essos_fieldline_import_package(
    *,
    ...
    """Export ESSOS-produced fields and field lines into a `jax_drb` artifact."""
...
def save_essos_fieldline_import_plot(bundle: EssosFieldLineBundle, path: str | Path) -> Path:
    ...
    axp.grid(alpha=0.28)
    axp.set_title("ESSOS Poincare sections imported into jax_drb")
    axp.legend(frameon=False, loc="upper right")

    fig.suptitle("External ESSOS field-line import for JAXDRB geometry/FCI workflows", fontsize=13)
