...
def build_shifted_metric_fft_phases(
    ...
    *,
    ...
    """Precompute FFT phases for Hermes/BOUT `ShiftedMetric`."""
...
def shifted_metric_fft_phases_from_geometry(geom: Any) -> ShiftedMetricFFTPhases:
    """Build FFT phase cache from an existing geometry adapter."""
...
def to_field_aligned_nox_fft_ref(
    ...
    """Reference mirror of Hermes `ShiftedMetric::toFieldAligned(..., "RGN_NOX")`."""
...
def from_field_aligned_nobndry_fft_ref(
    ...
    """Reference mirror of Hermes `ShiftedMetric::fromFieldAligned(..., "RGN_NOBNDRY")`."""
...
def to_field_aligned_nox_fft(
    ...
    """Fused mirror of Hermes `ShiftedMetric::toFieldAligned(..., "RGN_NOX")`."""
...
def from_field_aligned_nobndry_fft(
    ...
    """Fused mirror of Hermes `ShiftedMetric::fromFieldAligned(..., "RGN_NOBNDRY")`."""
