...
def ideal_ballooning_gamma_hat(
    *,
    ...
    """Ideal-ballooning growth rate from Halpern et al. (2013) Eq. (16).

    This implements the reduced Sturm–Liouville eigenproblem (Dirichlet BCs):
    ...
    Returns:
        gamma_hat >= 0 (square-root of minus the most negative generalized eigenvalue).
    """
    ...
    # Build symmetric tridiagonal matrix for interior unknowns.
