...
def _load_axisymmetric_npz(path: str | Path, *, keys: dict[str, str]) -> dict[str, Any]:
    ...
    return {
        ...
        "curv_par": get_optional(keys.get("curv_par", "curv_par"), default=None),
        "dpar_factor": get_required(keys.get("dpar_factor", "dpar_factor")),
        "B": get_optional(keys.get("B", "B"), default=1.0),
        "z_shift": get_optional(keys.get("z_shift", "z_shift"), default=None),
        "J": get_optional(keys.get("J", "J"), default=None),
        "gpar": get_optional(keys.get("gpar", "gpar"), default=None),
...
def build_axisymmetric_field_aligned_adapter(
    *,
    ...
    return FieldAlignedGeometryAdapter.from_coefficients(
        ...
        curv_par=coeffs.get("curv_par"),
        dpar_factor=coeffs["dpar_factor"],
        B=coeffs.get("B", 1.0),
        z_shift=coeffs.get("z_shift"),
        jacobian=coeffs.get("J"),
        gpar=coeffs.get("gpar"),
