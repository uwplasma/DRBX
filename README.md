...
| HW2D turbulence | DRB2D SOL blob (closed→open) | DRB2D (hot-ion) |
| --- | --- | --- |
| <img src="examples/assets/readme/hw2d_turbulence.gif" width="360" height="270" /> | <img src="examples/assets/readme/drb2d_sol_blob.gif" width="360" height="270" /> | <img src="examples/assets/readme/drb2d_hot_ion_turbulence.gif" width="360" height="270" /> |
...
The SOL blob movie uses the closed→open relaxation setup with a seeded Gaussian blob near the LCFS.
The DRB2D defaults include weak hyperdiffusion and a small zonal-vorticity drag to avoid long-time
collapse into a purely banded/zonal state on coarse grids; these are numerical control knobs and
should be reported explicitly when used.
