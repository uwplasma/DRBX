...
| --- | --- | --- | --- |
| MPSE/sheath-entrance closures (Bohm/Loizu; heat/SEE knobs) | [x] | [ ] | [ ]† |
| Non‑Boussinesq polarization | [x]‡ | [x] | [ ] |
| Hot ions (`Ti`) | [x] | [x] | [ ] |
| Electromagnetic (`psi ~ A_parallel`) | [x] | [x] | [ ] |
| Neutrals (`N` + exchange terms) | [ ] | [x] | [ ] |
| Conservative invariants / budget gates | [x] | [x] | [x]§ |

† FCI/3D currently includes slab “sheath budget” milestones, not the full Bohm/Loizu closure set on targets.  
...
## Nonlinear movies (HW2D and DRB2D)
