#!/usr/bin/env python3
"""Repository entry point for the portable P06 curvature qualification."""
...
def verify(args):
    ...
    manifest = {'schema':'drbx.p06-curvature-campaign-v1', 'content_identity':content,
...
def main():
    ...
    parser.add_argument('--output', type=Path, default=REPO/'work/p06_curvature_global_v1')
