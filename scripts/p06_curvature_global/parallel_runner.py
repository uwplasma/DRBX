#!/usr/bin/env python3
"""Portable spawn-safe chunk runner for the P06 HSX curvature campaign.
...
CONFIG_SCHEMA = "drbx.p06-curvature-portable-config-v1"
PLAN_SCHEMA = "drbx.p06-curvature-work-plan-v1"
RECEIPT_SCHEMA = "drbx.p06-curvature-parallel-receipt-v1"
THREAD_ENV = {
    "OMP_NUM_THREADS": "1",
...
def _materialize(
    ...
    runtime = {
        "schema": "drbx.p06-curvature-global-runtime-v1",
        "time": portable["time"],
...
def command_compare(args: argparse.Namespace) -> int:
    ...
    report = {
        "schema": "drbx.p06-curvature-parallel-comparison-v1", "status": "pass" if exact else "fail",
