...
def _campaign_command_map(
    *,
    ...
    return {
        ...
        "dthe-fixed-bdf2-promoted-active-sources-gate": CampaignCommand(
            name="dthe-fixed-bdf2-promoted-active-sources-gate",
            description=(
                "D/T/He promoted active-source fixed-BDF2 output-window gate "
                "that requires a nontrivial JAX-GMRES/JVP solve."
            ),
            command=(
                python_executable,
                ...
                *reference_args,
                ...
                str(
                    output_root
                    / "runtime_profile_artifacts"
                    / "recycling_dthe_fixed_bdf2_promoted_active_sources_cpu"
        ...
        "dthe-fixed-bdf2-active-array-gate": CampaignCommand(
            name="dthe-fixed-bdf2-active-array-gate",
            description=(
                "Bounded D/T/He fixed-BDF2 active-array output-window gate "
            ...
            command=(
                ...
                *reference_args,
                ...
                str(
                    output_root
                    / "runtime_profile_artifacts"
                    / "recycling_dthe_fixed_bdf2_active_array_direct_counting_cpu"
                    / "profile_summary.json"
                ),
            ),
            requires_reference=True,
        ...
        "dthe-fixed-bdf2-active-array-physical-parity-gate": CampaignCommand(
            name="dthe-fixed-bdf2-active-array-physical-parity-gate",
            description=(
                "Eight-step D/T/He fixed-BDF2 active-array physical-output "
                "parity gate against the stable BDF route."
            ),
            command=(
                python_executable,
                str(scripts / "compare_recycling_transient_modes.py"),
                ...
                *reference_args,
                ...
                str(
                    output_root
                    / "runtime_profile_artifacts"
                    / "recycling_dthe_fixed_bdf2_active_array_physical_parity_cpu"
                    / "profile_summary.json"
                ),
            ),
            requires_reference=True,
        ...
        "dthe-fixed-bdf2-active-array-scalar-observable-gate": CampaignCommand(
            name="dthe-fixed-bdf2-active-array-scalar-observable-gate",
            description=(
                "Production-timestep D/T/He fixed-BDF2 active-array scalar "
                "observable parity screen against the stable BDF route."
            ),
            command=(
                python_executable,
                str(scripts / "compare_recycling_transient_modes.py"),
                ...
                *reference_args,
                ...
                str(
                    output_root
                    / "runtime_profile_artifacts"
                    / "recycling_dthe_fixed_bdf2_active_array_scalar_observable_cpu"
                    / "profile_summary.json"
                ),
            ),
            requires_reference=True,
        ...
        "dthe-fixed-bdf2-active-array-substepped-full-field-gate": CampaignCommand(
            name="dthe-fixed-bdf2-active-array-substepped-full-field-gate",
            description=(
                "Production-timestep D/T/He fixed-BDF2 active-array full-field "
                "parity screen with an explicit internal timestep cap."
            ),
            command=(
                python_executable,
                str(scripts / "compare_recycling_transient_modes.py"),
                ...
                *reference_args,
                ...
                "runtime:recycling_jax_linear_initial_residual_mode=linearize",
                "--override",
                "runtime:recycling_fixed_bdf2_max_internal_timestep=2.5e-3",
                "--output-json",
                str(
                    output_root
                    / "runtime_profile_artifacts"
                    / "recycling_dthe_fixed_bdf2_active_array_substepped_full_field_cpu"
                    / "profile_summary.json"
                ),
            ),
            requires_reference=True,
        ...
        "adaptive-bdf-jax-lineax-gate": CampaignCommand(
            ...
            command=(
                ...
                *reference_args,
                ...
                "480",
                "--output-json",
                str(output_root / "runtime_profile_artifacts" / "recycling_1d_adaptive_bdf_jax_lineax_gate" / "profile_summary.json"),
            ),
            requires_reference=True,
            required_reference_inputs=("hydrogen",),
        ),
        ...
        if name == "all-local":
            expanded.extend(
                (
                    ...
                    "dthe-fixed-bdf2-promoted-active-sources-gate",
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "dthe-fixed-bdf2-active-array-scalar-observable-gate, "
            "dthe-fixed-bdf2-active-array-substepped-full-field-gate, "
            "fixed-bdf2-direct-counting-gate, "
