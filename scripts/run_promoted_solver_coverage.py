...
PROMOTED_SOLVER_TESTS = (
    ...
    "tests/test_native_recycling_1d_state.py",
    "tests/test_native_recycling_active_sources.py",
    "tests/test_native_recycling_anomalous_diffusion.py",
    "tests/test_native_recycling_atomic.py",
    "tests/test_native_recycling_boundaries.py",
    "tests/test_native_recycling_collision_closure.py",
    "tests/test_native_recycling_collisions.py",
    "tests/test_native_recycling_feedback.py",
    "tests/test_native_recycling_fields.py",
    "tests/test_native_recycling_fixed_residual.py",
    "tests/test_native_recycling_history.py",
    "tests/test_native_recycling_layout.py",
    "tests/test_native_recycling_neutral_diffusion.py",
    "tests/test_native_recycling_open_field_state.py",
    "tests/test_native_recycling_reactions.py",
    "tests/test_native_recycling_rhs_terms.py",
    "tests/test_native_recycling_sanitize.py",
    "tests/test_native_recycling_setup.py",
    "tests/test_native_recycling_source_accumulation.py",
    "tests/test_native_recycling_state.py",
    "tests/test_native_recycling_targets.py",
    "tests/test_recycling_diagnostics.py",
    "tests/test_recycling_jvp_promotion_gate.py",
    "tests/test_recycling_mode_diagnostics.py",
    "tests/test_native_integrated_2d_recycling.py",
    "tests/test_native_runner_cache.py",
    "tests/test_native_runner_compare.py",
    "tests/test_native_runner_dispatch.py",
    "tests/test_native_runner_dump.py",
    "tests/test_native_runner_execution.py",
    "tests/test_native_runner_reference.py",
...
PROMOTED_SOLVER_TARGETS = (
    ...
    "src/jax_drb/native/recycling_fixed_residual.py",
    "src/jax_drb/native/recycling_layout.py",
