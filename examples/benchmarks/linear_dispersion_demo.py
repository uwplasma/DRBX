...
It writes ``linear_dispersion.png`` and ``linear_dispersion.json`` under
``output/linear_dispersion/``.
...
OUTPUT_DIR = Path(__file__).resolve().parents[1].parent / "output" / "linear_dispersion"
