...
def main() -> None:
    ...
    parser.add_argument("--pert-mode", type=int, default=12)
    parser.add_argument("--nu", type=float, default=5.0e-5)
    parser.add_argument("--nu4", type=float, default=2.0e-7)
    parser.add_argument("--forcing-amp", type=float, default=1.5e-3)
    parser.add_argument("--forcing-kmax", type=float, default=8.0)
