...
def main() -> None:
    ...
    print(f"  - reference_mesh_spec: {args.reference_mesh_spec if args.reference_mesh_spec is not None else '<synthetic preview>'}")
    print(f"  - candidate_mesh_spec: {args.candidate_mesh_spec if args.candidate_mesh_spec is not None else '<synthetic preview>'}")
    print("")
    print("== Artifacts ==")
