...
from jax_drb.validation import build_stellarator_fci_geometry_report, save_stellarator_fci_geometry_plot

OUTPUT_ROOT = Path("docs/data/stellarator_fci_example_artifacts/geometry")
CASE_LABEL = "stellarator_geometry_plotting_demo"
