...
def main() -> None:
    ...
    parser.add_argument("--substeps-per-frame", type=int, default=4, help="JAXDRB substeps between movie frames.")
    parser.add_argument("--dt", type=float, default=2.0e-3, help="Explicit reduced transient substep.")
