...
def main() -> None:
    ...
    parser.add_argument("--nx", type=int, default=7, help="Number of VMEC-shaped radial grid points.")
    parser.add_argument("--ny", type=int, default=14, help="Number of toroidal planes.")
    parser.add_argument("--nz", type=int, default=40, help="Number of poloidal grid points.")
    ...
    parser.add_argument("--times-to-trace", type=int, default=420, help="ESSOS trace samples per seed.")
    parser.add_argument("--maxtime", type=float, default=90.0, help="ESSOS field-line integration time.")
    parser.add_argument("--frames", type=int, default=28, help="Number of saved movie frames.")
    parser.add_argument("--substeps-per-frame", type=int, default=5, help="JAXDRB substeps between movie frames.")
    parser.add_argument("--dt", type=float, default=1.5e-3, help="Explicit reduced transient substep.")
