...
def main() -> None:
    ...
    parser.add_argument(
        "--output-root",
        type=Path,
        default=Path("docs/data/native_3d_runtime_campaign_artifacts"),
    )
    args = parser.parse_args()
    artifacts = create_native_3d_runtime_campaign_package(output_root=args.output_root)
    print("== Native 3D Runtime Campaign ==")
