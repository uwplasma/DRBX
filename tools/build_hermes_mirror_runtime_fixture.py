#!/usr/bin/env python3
"""Build a stitched global Hermes ExB runtime fixture from BOUT dumps."""
...
def main() -> None:
    ...
    fields_3d = ("Ne", "Pe", "phi", "term_Ne_exb", "term_Pe_exb")
    fields_2d = ("J", "dx", "dy", "dz", "g11", "g23", "Bxy", "zShift")
    ...
    payload["zlength"] = np.asarray(
        float(np.asarray(payload["dz"]).mean()) * float(nbinorm),
        dtype=np.float64,
    )
