...
| Implicit solver and JAX-native seams | [Performance And Differentiability](performance_and_differentiability.md), [Profiling Runtime](profiling_runtime.md) | linear operators, preconditioner options, tolerances | nonlinear residual reports, JVP/GMRES diagnostics | [`src/jax_drb/solver/implicit.py`](https://github.com/uwplasma/jax_drb/blob/main/src/jax_drb/solver/implicit.py), [`src/jax_drb/solver/elliptic.py`](https://github.com/uwplasma/jax_drb/blob/main/src/jax_drb/solver/elliptic.py) | [`tests/test_solver_implicit.py`](https://github.com/uwplasma/jax_drb/blob/main/tests/test_solver_implicit.py), [`tests/test_solver_elliptic.py`](https://github.com/uwplasma/jax_drb/blob/main/tests/test_solver_elliptic.py) |
