...
| Differentiability, UQ, and inverse design | [`examples/autodiff_diffusion_sensitivity.py`](https://github.com/uwplasma/jax_drb/blob/main/examples/autodiff_diffusion_sensitivity.py), [`examples/autodiff_diffusion_uncertainty.py`](https://github.com/uwplasma/jax_drb/blob/main/examples/autodiff_diffusion_uncertainty.py), [`examples/autodiff_diffusion_inverse_design.py`](https://github.com/uwplasma/jax_drb/blob/main/examples/autodiff_diffusion_inverse_design.py) | differentiable scalar objectives, covariance, design parameters | sensitivity plots, covariance pushforward plots, optimization traces | [`src/jax_drb/validation/autodiff_diffusion.py`](https://github.com/uwplasma/jax_drb/blob/main/src/jax_drb/validation/autodiff_diffusion.py), [`src/jax_drb/validation/autodiff_diffusion_uncertainty.py`](https://github.com/uwplasma/jax_drb/blob/main/src/jax_drb/validation/autodiff_diffusion_uncertainty.py) | [`tests/test_validation_autodiff_diffusion.py`](https://github.com/uwplasma/jax_drb/blob/main/tests/test_validation_autodiff_diffusion.py), [`tests/test_validation_autodiff_diffusion_uncertainty.py`](https://github.com/uwplasma/jax_drb/blob/main/tests/test_validation_autodiff_diffusion_uncertainty.py) |
| Hasegawa-Wakatani turbulence and inverse design | [`examples/tokamak/drift_wave_turbulence.py`](https://github.com/uwplasma/jax_drb/blob/main/examples/tokamak/drift_wave_turbulence.py), [`examples/tokamak/drift_wave_inverse_design.py`](https://github.com/uwplasma/jax_drb/blob/main/examples/tokamak/drift_wave_inverse_design.py), [Tutorial](tutorial_hasegawa_wakatani.md) | grid size, adiabaticity, gradient drive, hyperviscosity, RK4 step | vorticity GIF, energy/flux histories, sensitivity and recovery JSON | [`src/jax_drb/native/hasegawa_wakatani.py`](https://github.com/uwplasma/jax_drb/blob/main/src/jax_drb/native/hasegawa_wakatani.py) | [`tests/test_hasegawa_wakatani.py`](https://github.com/uwplasma/jax_drb/blob/main/tests/test_hasegawa_wakatani.py) |
| Open SOL flux tube, neutrals, detachment | [`examples/sol/open_sol_flux_tube.py`](https://github.com/uwplasma/jax_drb/blob/main/examples/sol/open_sol_flux_tube.py), [`examples/sol/recycling_sol.py`](https://github.com/uwplasma/jax_drb/blob/main/examples/sol/recycling_sol.py), [`examples/benchmarks/b6_detachment_rollover.py`](https://github.com/uwplasma/jax_drb/blob/main/examples/benchmarks/b6_detachment_rollover.py), [Tutorial](tutorial_open_sol.md) | connection length, source strength, recycling fraction, upstream density/power scans | two-point profiles, detachment-onset and rollover figures, JSON summaries | [`src/jax_drb/native/sol_flux_tube.py`](https://github.com/uwplasma/jax_drb/blob/main/src/jax_drb/native/sol_flux_tube.py), [`src/jax_drb/native/neutrals/`](https://github.com/uwplasma/jax_drb/tree/main/src/jax_drb/native/neutrals) | [`tests/test_open_field_line_sol.py`](https://github.com/uwplasma/jax_drb/blob/main/tests/test_open_field_line_sol.py), [`tests/test_native_recycling_sol.py`](https://github.com/uwplasma/jax_drb/blob/main/tests/test_native_recycling_sol.py), [`tests/test_native_detachment_sol.py`](https://github.com/uwplasma/jax_drb/blob/main/tests/test_native_detachment_sol.py) |
| Stellarator turbulence, closed vs limiter-open | [`examples/stellarator/stellarator_turbulence.py`](https://github.com/uwplasma/jax_drb/blob/main/examples/stellarator/stellarator_turbulence.py), [Tutorial](tutorial_stellarator_fci.md) | rotating-ellipse shape, limiter radius, 4-field parameters, phi-solver tolerances | closed/open GIF movies, particle-content and limiter-flux summary | [`src/jax_drb/native/fci_4_field_rhs.py`](https://github.com/uwplasma/jax_drb/blob/main/src/jax_drb/native/fci_4_field_rhs.py), [`src/jax_drb/native/stellarator_turbulence.py`](https://github.com/uwplasma/jax_drb/blob/main/src/jax_drb/native/stellarator_turbulence.py) | [`tests/test_stellarator_turbulence.py`](https://github.com/uwplasma/jax_drb/blob/main/tests/test_stellarator_turbulence.py) |
| Linear dispersion and the linearized-DRB engine | [`examples/benchmarks/linear_dispersion.py`](https://github.com/uwplasma/jax_drb/blob/main/examples/benchmarks/linear_dispersion.py), [`examples/benchmarks/linear_drb_survey.py`](https://github.com/uwplasma/jax_drb/blob/main/examples/benchmarks/linear_drb_survey.py) | wavenumbers, adiabaticity, Alfven speed, curvature drive | dispersion-vs-analytic figures, regime survey | [`src/jax_drb/linear/`](https://github.com/uwplasma/jax_drb/tree/main/src/jax_drb/linear) | [`tests/test_linear_dispersion.py`](https://github.com/uwplasma/jax_drb/blob/main/tests/test_linear_dispersion.py) |
| vmec_jax equilibrium import | [`examples/geometry-3D/vmec-jax/closed_field_lines.py`](https://github.com/uwplasma/jax_drb/blob/main/examples/geometry-3D/vmec-jax/closed_field_lines.py), [`examples/geometry-3D/vmec-jax/closed_open_field_lines.py`](https://github.com/uwplasma/jax_drb/blob/main/examples/geometry-3D/vmec-jax/closed_open_field_lines.py) | `wout_*.nc` equilibrium, `JAX_DRB_VMEC_JAX_ROOT` checkout | surface-field maps, traced field lines, iota verification, LCFS overlays | [`src/jax_drb/geometry/vmec_jax_import.py`](https://github.com/uwplasma/jax_drb/blob/main/src/jax_drb/geometry/vmec_jax_import.py) | traced iota vs wout `iotaf` (~1e-6) inside the examples |
| Synthetic stellarator FCI and reduced SOL | [`examples/geometry-3D/stellarator-fci/nonlinear_turbulence.py`](https://github.com/uwplasma/jax_drb/blob/main/examples/geometry-3D/stellarator-fci/nonlinear_turbulence.py), [Stellarator Examples](stellarator_examples.md) | analytic non-axisymmetric geometry constants, FCI maps, reduced turbulence settings | geometry plots, linear mode, nonlinear GIF, profile analysis | [`src/jax_drb/geometry/stellarator.py`](https://github.com/uwplasma/jax_drb/blob/main/src/jax_drb/geometry/stellarator.py), [`src/jax_drb/native/fci.py`](https://github.com/uwplasma/jax_drb/blob/main/src/jax_drb/native/fci.py), [`src/jax_drb/native/fci_drb_rhs.py`](https://github.com/uwplasma/jax_drb/blob/main/src/jax_drb/native/fci_drb_rhs.py), [`src/jax_drb/validation/stellarator_sol_showcase.py`](https://github.com/uwplasma/jax_drb/blob/main/src/jax_drb/validation/stellarator_sol_showcase.py) | [`tests/test_geometry_fci_maps.py`](https://github.com/uwplasma/jax_drb/blob/main/tests/test_geometry_fci_maps.py), [`tests/test_validation_stellarator_fci_campaigns.py`](https://github.com/uwplasma/jax_drb/blob/main/tests/test_validation_stellarator_fci_campaigns.py) |
