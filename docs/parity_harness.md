...
| `integrated_2d_recycling_one_step` | `scaffolded_reference_backed` | Stable integrated 2D recycling first-output target with staged grid artifact, 10-rank launch, committed one-step baselines, and a dump-backed transient scaffold that now stays inside a bounded operational band. |
| `integrated_2d_recycling_short_window` | `scaffolded_reference_backed` | Stable integrated 2D recycling short-window target with staged grid artifact, 10-rank launch, committed reference baselines, and a dump-backed transient scaffold that stays inside a bounded operational band over `nout=5`. |
| `integrated_2d_recycling_medium_window` | `scaffolded_reference_backed` | Stable integrated 2D recycling medium-window target with staged grid artifact, 10-rank launch, committed reference baselines, and a dump-backed transient scaffold that also stays inside a bounded operational band over the staged `nout=20` window. |
