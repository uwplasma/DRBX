...
- the neutral runner path is now enabled for `neutral_mixed_one_step` and `neutral_mixed_short_window`, and the latest bounded one-step compare tightened materially after matching the reference neutral density wall extrapolation (`center Nh ≈ 8.0e-3`, `center Ph ≈ 5.7e-4`, `center NVh ≈ 8.6e-4`, `center T ≈ 2.9e-4`, `momentum RMS ≈ 1.7e-3` max-abs error at the locked `(5,3,5)` probe). The same native backbone now also clears a bounded full short-window metric gate on the matrix-free path (`center Nh ≈ 8.03e-3`, `center Ph ≈ 6.47e-4`, `center NVh ≈ 8.60e-4`, `center T ≈ 2.91e-4`, `total Nh ≈ 3.24e-1`, `total Ph ≈ 2.89e-2`, `momentum RMS ≈ 1.71e-3`) and a bounded trimmed active-domain full-array gate on `Nh`/`Ph`/`NVh` (`Nh max|Δ| ≈ 1.27e-2`, `Ph max|Δ| ≈ 1.21e-3`, `NVh max|Δ| ≈ 3.37e-3`), so the remaining neutral work is no longer the existence of a short-window field surface at all;
