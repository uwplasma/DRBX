...
- the next native open-field milestone is `recycling_dthe_rhs`; live reference comparisons now show that the remaining gap is primarily in the multispecies collisional closure, not in the shared sheath/recycling scaffolding or the summary/array harness;
