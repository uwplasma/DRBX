...
`drbx`, exactly as they are discretized in the source code: the evolved
...
**Module:** [`native/hasegawa_wakatani.py`](../src/drbx/native/hasegawa_wakatani.py) —
...
**Module:** [`native/sol_flux_tube.py`](../src/drbx/native/sol_flux_tube.py)
on the open slab geometry
([`geometry/open_slab.py`](../src/drbx/geometry/open_slab.py)).
...
[`reactions.py`](../src/drbx/native/neutrals/reactions.py) assembles the
source channels
...
[`recycling_sol_model.py`](../src/drbx/native/neutrals/recycling_sol_model.py)
...
**Package:** [`src/drbx/linear/`](../src/drbx/linear) — growth rates
...
- `jacobian_operator(rhs, equilibrium)` builds \(A\) from **any** JAX RHS with
  ...
  spectrum ([`linear/eigen.py`](../src/drbx/linear/eigen.py));
- three analytic single-mode operators assembled directly from the model
  equations ([`linear/dispersion.py`](../src/drbx/linear/dispersion.py)):
...
The `drbx run` TOML lanes solve smaller accuracy-tested systems documented
in [Physics Models](physics_models.md): anomalous radial diffusion (matrix
exponential propagator, [`native/transport.py`](../src/drbx/native/transport.py)),
the periodic 1-D fluid MMS system ([`native/fluid_1d.py`](../src/drbx/native/fluid_1d.py)),
and the electrostatic vorticity model
([`native/vorticity.py`](../src/drbx/native/vorticity.py)) whose potential
