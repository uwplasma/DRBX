...
- active-domain grouped difference-quotient sparse Jacobian assembly, sparse Newton/GMRES nonlinear solve substrate, and BDF2 residual/step helpers for the neutral branch, staged for the upcoming direct sparse transient pass but still behind the validated matrix-free default.
