...
coordinates. In `drbx` you never derive that metric by hand:

```python
from drbx.geometry import build_rotating_ellipse_geometry
...
`metric_from_position_fn` ([`geometry/embedding.py`](../src/drbx/geometry/embedding.py))
