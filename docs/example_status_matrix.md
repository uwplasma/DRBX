...
| [`examples/geometry-3D/essos-field-lines/direct_coil_closed_field_demo.py`](../examples/geometry-3D/essos-field-lines/direct_coil_closed_field_demo.py) | self-contained control with opt-in live ESSOS regeneration | closed/near-closed Poincare, return-map classification, and refinement stability | [ESSOS Direct-Coil Closed Control](essos_direct_coil_closed_control.md) |
