...
| [`examples/geometry-3D/essos-field-lines/direct_coil_closed_field_demo.py`](../examples/geometry-3D/essos-field-lines/direct_coil_closed_field_demo.py) | self-contained control with opt-in live ESSOS regeneration | closed/near-closed Poincare and return-map classification | [ESSOS Direct-Coil Closed Control](essos_direct_coil_closed_control.md) |
| [`examples/geometry-3D/essos-field-lines/vmec_closed_field_demo.py`](../examples/geometry-3D/essos-field-lines/vmec_closed_field_demo.py) | self-contained contract with opt-in live ESSOS/VMEC regeneration | closed VMEC FCI map and constant-state operator gates | [ESSOS VMEC Closed Field](essos_vmec_closed_field.md) |
...
| [`examples/geometry-3D/essos-field-lines/imported_connection_length_refinement_demo.py`](../examples/geometry-3D/essos-field-lines/imported_connection_length_refinement_demo.py) | self-contained manufactured validation | nested connection-length refinement report and plot | [ESSOS Imported FCI Validation](essos_imported_fci_validation.md) |
...
| [`examples/geometry-3D/essos-field-lines/imported_drb_movie_refinement_campaign.py`](../examples/geometry-3D/essos-field-lines/imported_drb_movie_refinement_campaign.py) | developer report-only regeneration | imported QA DRB grid/time reports and refinement summary without GIF/NPZ media | [ESSOS Imported DRB Movie](essos_imported_drb_movie.md) |
| [`examples/geometry-3D/essos-field-lines/imported_drb_movie_refinement_summary.py`](../examples/geometry-3D/essos-field-lines/imported_drb_movie_refinement_summary.py) | self-contained report audit | report-only grid/time refinement summary for imported DRB movies | [ESSOS Imported DRB Movie](essos_imported_drb_movie.md) |
