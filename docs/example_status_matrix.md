...
| --- | --- | --- | --- |
| MMS and operators | [`examples/engineering/fluid_1d_mms_convergence_demo.py`](../examples/engineering/fluid_1d_mms_convergence_demo.py) | self-contained validation | [Fluid 1D MMS Convergence](fluid_1d_mms_convergence.md) || Neutrals and target recycling | [`examples/engineering/neutral_mixed_term_balance_campaign_demo.py`](../examples/engineering/neutral_mixed_term_balance_campaign_demo.py) | self-contained or cached-reference validation | [Neutral Mixed Term Balance](neutral_mixed_term_balance_campaign.md) |
