...
| Neutral, recycling, sheath, detachment | 79% | Neutral parallel diffusion now has an active-layout source seam with full-field active-slice parity and JVP gates; finish sheath/target-source gates and detachment observables across promoted tokamak lanes. |
