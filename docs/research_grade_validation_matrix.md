...
about `3.23e-3`; `eta_h` is still about `99` times larger than the largest
state-input drift. At the worst upper-target cell, native `grad_logPnlimh` is
