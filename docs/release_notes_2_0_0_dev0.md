...
[`plan_dkx.md`](https://github.com/uwplasma/dkx/blob/main/plan_dkx.md).
...
- Coverage is a single whole-package branch-coverage number over
  `src/dkx` (baseline 86%); the curated closeout/promoted coverage
  gates were removed.
...
- Incorporated the FCI operator/sharding stack from
  [PR #3](https://github.com/uwplasma/dkx/pull/3) by Aiken Xie:
...
`plan_dkx.md`. In this dev series the previously shipping gates remain
