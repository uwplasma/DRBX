...
- the neutral mixed mismatch is now small in absolute units but remains useful
  as a source-term and boundary-history regression because it exercises
  pressure-gradient and viscosity closures directly
