...
from jaxdrb.analysis.ideal_ballooning import ideal_ballooning_gamma_hat
...
def test_ideal_ballooning_has_threshold_near_shat0() -> None:
    # Halpern et al. report a finite threshold around alpha_crit ~ O(0.5) for Dirichlet BCs.
...
def test_ideal_ballooning_critical_alpha_boundary_is_reasonable() -> None:
