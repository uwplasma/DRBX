...
from drbx.native.fci_model import FciFieldBundle
...
def _build_local_4field_invariants(
    ...
    *,
    ...
    from drbx.geometry.fci_geometry import build_local_curvature_coefficients
    from drbx.native.fci_operators import build_local_perp_laplacian_face_projectors
...
def _prepare_local_shifted_torus_4field_stage_state(
    ...
    *,
    ...
    from drbx.native.fci_boundaries import LocalBoundaryData3D
    from drbx.native.fci_halo import LocalHaloClosure3D, PreparedLocalState3D
