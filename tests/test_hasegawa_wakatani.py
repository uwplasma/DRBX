...
``drbx.linear.resistive_drift_wave_operator``. Further tests cover the ideal
...
def test_single_mode_has_zero_self_bracket() -> None:
    ...
    from drbx.native.hasegawa_wakatani import _bracket_hat
...
def test_example_scripts_parse_and_stay_flat(filename) -> None:
    ...
    imported = [
        ...
        and node.module == "drbx.native.hasegawa_wakatani"
        for alias in node.names
    ]
    assert imported, f"{filename} must use the public Hasegawa-Wakatani API"
    import drbx.native.hasegawa_wakatani as hw
...
def test_turbulence_example_api_path() -> None:
    ...
    from drbx.native.hasegawa_wakatani import hw_run
...
def test_optimization_example_api_path() -> None:
    ...
    from drbx.native.hasegawa_wakatani import hw_run, hw_run_flux_history
