...
PUBLIC_RELEASE_FILES = (
    ...
    REPO_ROOT / "docs" / "essos_biot_savart_landreman_paul_qa.md",
    ...
    REPO_ROOT / "examples" / "geometry-3D" / "essos-biot-savart" / "landreman_paul_qa_campaign.py",
    ...
    REPO_ROOT / "src" / "jax_drb" / "geometry" / "biot_savart.py",
    REPO_ROOT / "src" / "jax_drb" / "validation" / "essos_biot_savart_campaign.py",
...
PUBLIC_JSON_ARTIFACTS = (
    ...
    REPO_ROOT / "docs" / "data" / "essos_biot_savart_landreman_paul_qa_artifacts" / "data" / "essos_biot_savart_landreman_paul_qa_campaign.json",
