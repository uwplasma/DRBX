...
| B2 | V1 | Resistive drift-wave dispersion (resistivity scan) | BOUT++: Dudson et al., CPC 180, 1467 (2009), arXiv:0810.5757 | γ(k), ω(k) from the NEW linear solver vs analytic dispersion within a few %; density–potential phase shift correct |
| B3 | V1 | Shear-Alfvén wave dispersion incl. electron inertia (β, k⊥ scan) | Stegmeir et al., PoP 26, 052517 (2019), arXiv:1904.09230 | phase velocity vs v_A/(1+k⊥²δe²)^½ at ~1% and converging |
